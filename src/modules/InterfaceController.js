...
const showSideBarBtn = () => {
    ...
    let hidden = sideBar.classList.contains('hidden');
...
export {
    loadProjForm, renderProjects, loadTaskForm, renderAllTasks,
    renderAllWithInInterval, renderAllImportantTasks, showSideBarBtn, switchTheme
};